...
| Document | Role |
|----------|------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | Layer definitions, naming philosophy, dependency direction, surface roles |
| [SKILL.md](SKILL.md) | lint-arwaky CLI — the tool that enforces these rules |
| [PRD.md](PRD.md) | Project context — PSD Timelapse product vision and feature scope |
